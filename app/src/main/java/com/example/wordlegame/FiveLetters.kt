...
class FiveLetters : Fragment() {
    ...
    override fun onCreateView(
        ...
        rootView = inflater.inflate(R.layout.five_letters, container, false)

        tableLayout = rootView.findViewById<TableLayout>(R.id.table_layout_5)
        ...
        rootView.findViewById<TextView>(R.id.title).text = "Five Letter Wordle"
