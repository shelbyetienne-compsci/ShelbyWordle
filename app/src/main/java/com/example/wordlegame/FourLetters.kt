...
class FourLetters : Fragment() {
    ...
    override fun onCreateView(
        ...
        rootView = inflater.inflate(R.layout.four_letters, container, false)

        tableLayout = rootView.findViewById(R.id.table_layout_4)
        ...
        rootView.findViewById<TextView>(R.id.title).text = "Four Letter Wordle"
